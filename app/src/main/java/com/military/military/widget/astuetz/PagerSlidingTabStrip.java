...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int underlineColor = 0xff18bda4;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs,
        ...
        selectedTabTextColor = a
                .getColor(R.styleable.PagerSlidingTabStrip_pstsSelectedTabTextColor,
        ...
        tabTextSize = a.getDimensionPixelSize(
                R.styleable.PagerSlidingTabStrip_pstsTabTestSize,
                tabTextSize);
    ...
    public void setViewPager(ViewPager pager, boolean is_use_linear) {
        this.pager = pager;
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof IconTabProvider) {
                ...
                if (is_use_linear) {
                    addLiearTab(i, pager.getAdapter().getPageTitle(i).toString(),
                            isShowImage);
                } else {
