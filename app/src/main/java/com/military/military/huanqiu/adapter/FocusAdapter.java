...
import com.military.military.transforms.CubeOutTransformer;
import com.military.military.transforms.TransformerItem;
import com.military.military.widget.convenientbanner.ConvenientBanner;
import com.military.military.widget.convenientbanner.holder.CBViewHolderCreator;
import com.military.military.widget.convenientbanner.holderview.NetworkImageHolderView;
...
public class FocusAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_HEADER) {
            return new HeaderHolder(LayoutInflater.from(mContext).inflate(R.layout.header_focus,parent,false));
        }else {
